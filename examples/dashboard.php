        ...
        <div class="header-body">
          ...
          <center>
            <?php
              ...
              $query="select * from funquiz where show1  like 'shown' ";
              $y=mysqli_num_rows (mysqli_query($db,$query));
              $query1="select * from funquiz   ";
              $y1=mysqli_num_rows (mysqli_query($db,$query1));
              if($y>=$y1)
              $y2=$y-$y1;
              else
              $y2=$y1-$y;            
...
<br><br><br>
      ...
      <div class="row">
        ...
        <div class="card">
            ...
            <div class="row" style="padding-left:50px">
             <?php 
            $as="SELECT count(batch) as m,batch FROM result group by batch";
    ...
    <center>
    <h2><i class="ni ni-trophy text-yellow"></i>'.$ba.'</h2>
    <div class="media-body  ml-2  d-none d-lg-block">
    <h1>
    <span class="mb-0 text-sm  font-weight-bold">'.$bat.'</span>
    </h1>
  </div>
