                ...
                <tbody class="list">
                  <tr>
                    ...
                    //$i=1;
                     ...
                     if($q!='')
                     {
                      $l="SELECT * FROM post_ans inner join result  on ((result.ass_no = post_ans.ass_no and un like '$un' )or e_date <'$today') and post_ans.ass_no LIKE  '$q%' or ass_name  LIKE  '$q%' or s_date  LIKE  '$q%'  or(( $t_ins  LIKE  'clg' and ins LIKE '$ins' ) or t_ins  LIKE  'general') or status LIKE  '$q%'  and is_deleted like 'not deleted'  ";
