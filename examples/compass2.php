                ...
                <tbody class="list">
                  <tr>
                    ...
                    //$i=1;
                     ...
                     if($q!='')
                     {
                      $l="SELECT * FROM post_ans where (e_date <='$today'and e_time < '$ttt') and ((t_ins like '$t_ins' and ins like '$ins')  or t_ins like'general')   and is_deleted like 'not deleted' and (ass_no LIKE  '$q%' or ass_name  LIKE  '$q%' or s_date  LIKE  '$q%'  or t_ins  LIKE  '$q%' or status LIKE  '$q%')";
                     ...
                     else
                     {
                      ...
                      $l="SELECT * FROM post_ans where (e_date <='$today'and e_time < '$ttt') and ((t_ins like '$t_ins' and ins like '$ins')  or t_ins like'general')   and is_deleted like 'not deleted' ";
                     $y=mysqli_query($db,$l);
                     ...
                     $l="SELECT * FROM post_ans where (e_date <='$today'and e_time < '$ttt') and ((t_ins like '$t_ins' and ins like '$ins')  or t_ins like'general')   and is_deleted like 'not deleted'  limit $start,$per_page";
                      }
                     ...
                     while( $r = mysqli_fetch_assoc($y))
                       { 
                        $aa=$r['ass_no'];
                               $add="select marks_scored from result where ass_no='$aa' ";

                             $r11=mysqli_query($db,$add);
                              while( $r4 = mysqli_fetch_assoc($r11))
                       {   
