...
function closeNav() {
                ...
                <div class="card-body">
                  ...
                  echo $rq1."school";
                    ...
                    if($t=='clg')
                      ...
                      $qu=mysqli_query($db," select  count(ass_no) as c from post_ans where  ins like '$ins' and yr like '$yr' and   dept like '$dept' and s_date >='$today' and (s_time >='$ttt'   or e_time > '$ttt' )");
                      ...
                      $r = mysqli_fetch_assoc($qu);
                        ...
                        {  
                         ...
                         $count = mysqli_query($db,"select count(ass_no) as c  from post_ans where (ins like '$ins' or ins like 'general')  and class like '$yr' and   gp like '$dept'  and  s_date >='$today'  and (s_time >='$ttt'   or e_time > '$ttt' )");
                    ...
                    //echo $ttt;
                      ...
                      $qu=mysqli_query($db," select  * from post_ans where ( (ins like '$ins'  and yr like '$yr' and   dept like '$dept')or t_ins like 'general') and (((s_date >='$today' and s_time >='$ttt' )  or (e_date <='$today' and e_time > '$ttt' ))or (s_date <='$today'and s_time<='$ttt' and e_date <='$today' and e_time<='$ttt' ))and is_deleted like'nor deleted'");

                      
                   
                      $ee=mysqli_num_rows($qq);
                        ...
                        $qu=mysqli_query($db," select  * from post_ans where ( (ins like '$ins'  and class like '$yr' and   gp like '$dept')or t_ins like 'general') and (((s_date >='$today' and s_time >='$ttt' )  or (e_date <='$today' and e_time > '$ttt' ))or (s_date <='$today'and s_time<='$ttt' and e_date <='$today' and e_time<='$ttt' ))and is_deleted like'nor deleted'");

                      
                         $ss=mysqli_num_rows($qu);
                  ...
                  <div class="row">
                    <div class="col">
                     ...
                     /* if($t=='clg')
                      ...
                      $qu=mysqli_query($db," select count(ass_no) as c from post_ans where  ins like '$ins'  and yr like '$yr' and   dept like '$dept' and s_date <='$today' and s_time < '$ttt' and e_time <= '$ttt'  ");
                      if(mysqli_num_rows($qu) >0)
                          {
                        ...
                        else
                        {
                          ...
                          $qu=mysqli_query($db," select count(ass_no) as c from post_ans where  ins like '$ins'  and class like '$yr' and   gp like '$dept' and  s_date <='$today' and s_time <'$ttt'  and e_time <= '$ttt' ");
                          if(mysqli_num_rows($qu)>0)
                          {
  ...
  <div class="col-xl-9 order-xl-1">
        <div class="card" style="width:1500px;height:500px;">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <center>
        <div class="col" style="left:635px">
                  <h6 class="text-uppercase text-muted ls-1 mb-1" >Scored</h6>
                  <h5 class="h3 mb-0">Total Badges of <?php echo $m; ?></h5>
                </div>
             </center>
              </div>
            </div>
