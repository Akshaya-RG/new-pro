                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    //echo $ttt;
                      ...
                      $qu=mysqli_query($db," select  count(ass_no) as c from post_ans where  ins like '$ins'  and yr like '$yr' and   dept like '$dept' and s_date >='$today' and s_time >'$ttt' ");
                      ...
                      while($r = mysqli_fetch_assoc($qu))
                        ...
                        {  
                         ...
                         $count = mysqli_query($db,"select count(ass_no) as c  from post_ans where  ins like '$ins'  and class like $yr and   gp like '$dept'  and  s_date >='$today' and s_time >'$ttt';");
                      
                          if(mysqli_num_rows($count) >0)
                          {
                        
                           
                         while($r=mysqli_fetch_assoc($count))
                          {
